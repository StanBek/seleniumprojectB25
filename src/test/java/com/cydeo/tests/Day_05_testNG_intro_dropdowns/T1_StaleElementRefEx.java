...
public class T1_StaleElementRefEx {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement deleteButton= driver.findElement(By.xpath("//button[.='Delete']"));//button[@class='added-manually']
        ...
        try {
            ...
            System.out.println("---> This means the web is completely deleted from the page ");
        }
